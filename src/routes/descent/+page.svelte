...
<ChapterShell slug="descent">
	...
	<Prose>
		...
		<p>
			...
			few hundred; the model that plays chess in <ChapterRef slug="rook" /> has 1.3 million; the models
			in the news have billions. Nobody can draw those landscapes. But nothing on this page was a cartoon
			of the algorithm — the rule you have been racing is, line for line, the rule they all train by,
			and in <a href={resolve('/neuron')}>the next chapter</a> you will watch this same subtraction sculpt
			a real neural network, live, as you read.
		</p>
