...
export const rook: HoodChapter = {
	slug: 'rook',
	lesson: 'Lesson 7 — the full pipeline: pretrain, fine-tune, reinforce',
	lede: `Rook is the course's final exam: everything from the previous seven lessons, running as one system. The transformer is the scribe's architecture at 1.3 million parameters; the three training stages are <em>one engine with three diets</em>, not three models; checkpoints move weights through time; and the RLVR step is a policy gradient — chapter 6's idea — executed on the GPU with chapter 5's machinery.`,
	ml: [
		{
