...
export const digits: HoodChapter = {
	slug: 'digits',
	lesson: 'Lesson 3 — batches, held-out truth, and gradients of the input',
	lede: `Ten thousand real images raise the questions toy data never asks: how do you feed a GPU efficiently, how do you keep yourself honest about memorization, and what else is a gradient good for? The chapter's four plates share one engine and one set of weights — train in Plate III and every other plate feels it — which is also this book's first taste of treating a model as <em>infrastructure</em>.`,
	ml: [
		{
